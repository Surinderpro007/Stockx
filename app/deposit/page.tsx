...
import { 
  FaChartLine, FaMoneyBillWave, FaCreditCard, FaUniversity, 
  FaPaypal, FaCheck, FaArrowLeft, FaMoon, FaSun 
} from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h2 className="heading-1 mb-2">Deposit Funds</h2>
          <p className="text-gray-600 dark:text-gray-300">Add money to your trading account</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
              {success ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">Deposit Successful</h3>
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">Instant deposit with any major card</p>
                          </div>
                          <div className="ml-2">
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">Instant deposit from your PayPal account</p>
                          </div>
                          <div className="ml-2">
                            <div className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${
                              paymentMethod === 'paypal'
          ...
          <div>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Deposit Information</h3>
              ...
              <div className="space-y-4">
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                  ...
                  <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
                    <li className="flex items-start">
                      <FaCreditCard className="mt-1 mr-2 text-blue-600 dark:text-blue-400" />
                ...
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                  <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Deposit Limits</h4>
